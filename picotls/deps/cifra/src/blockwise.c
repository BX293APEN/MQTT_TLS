                                   ...
                                   void *ctx)
{
  ...
  pen_assert(partial && *npartial < nblock);
  pen_assert(inp || !nbytes);
  pen_assert(process && ctx);
  ...
  if (*npartial && nbytes)
  {
    ...
    pen_memcpy(partial + *npartial, bufin, taken);
                           ...
                           void *ctx)
{
  ...
  while (nbytes)
  {
    ...
    if (!filled)
      pen_memset(partial + start, byte, count);
